...
{
	//In MAX7221, data packets are 16 bits long (two bytes). You should first make CS low before transmitting; then you
	//transmit two bytes of data and terminate the transmission
	//by making CS high.
	//The first byte (MSBs) of each packet contains the command
	//control bits, and the second byte is the data to be displayed.
